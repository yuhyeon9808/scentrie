...
export default function MagazineCard({ magazines }: MagazineCardProps) {
  return (
    <div className="overflow-hidden rounded-md shadow-md transition-transform duration-200 hover:scale-105">
      <Link href={`/magazine/detail/${magazines.id}`}>
        <Image
          ...
          width={300}
          height={300}
          className="min-w-[300px] w-[300px] h-[300px] object-contain"
        />
      </Link>
    </div>
  );
